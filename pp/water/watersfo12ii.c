...
int main(){
	...
	//#pragma omp parallel for private(j) reduction(+:energy) schedule(static)
	//#pragma omp parallel for private(j) reduction(+:energy) schedule(dynamic, 10000)
	#pragma omp parallel for private(j) reduction(+:energy) schedule(auto)
